...
class OutdoorDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        """Define data splits."""
        return {
            'train': self._generate_examples(path='/hdd/outdoor_dataset_cleaned/train'),
            'val': self._generate_examples(path='/hdd/outdoor_dataset_cleaned/val'),
        }
