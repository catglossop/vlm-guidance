...
class AtomicDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        """Define data splits."""
        return {
            'train': self._generate_examples(path='/home/noam/LLLwL/datasets/atomic_dataset_sorted_turn_left/train'),
            'val': self._generate_examples(path='/home/noam/LLLwL/datasets/atomic_dataset_sorted_turn_left/val'),
        }
