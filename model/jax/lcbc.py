...
from model.jax.utils import NormalizationType, TokenGroup, PRNGKey, Sequence, Config, Data, Params
from model.jax.text_processing import TextProcessor
from model.jax.lcbc_components import LCBCEncoder, DiffusionActionHead, DenseActionHead

class LCBCModel:

    text_processor: TextProcessor
    encoder: LCBCEncoder
    action_head: Union[DiffusionActionHead, DenseActionHead]
    config: Config
    params: Params
    example_batch: Data
